...
namespace Tera.SkillEngine
{
    internal class SkillEngine : Global, ISkillEngine
    {
        ...
        private void ProcessMove(Creature creature, Skill skill)
        {
        ...
        private void ProcessArea(Creature creature, Skill skill, Targeting targeting, TargetingArea area,
                                       Projectile projectile = null)
        {
            try
            {
                ...
                if (targeting.Time > 0)
                    System.Threading.Thread.Sleep((int) (targeting.Time/skill.TimeRate));
                ...
                do
                {
                    ...
                    {
                        System.Threading.Thread.Sleep((int) (targeting.Interval/skill.TimeRate));
